...
def set_user(update: Update, context: CallbackContext):
    ...
    if args:
        ...
        msg.reply_text(f"Nama pengguna ditetapkan sebagai {username}!")
    else:
        msg.reply_text(
...
def clear_user(update: Update, _):
    ...
    update.effective_message.reply_text(
        "Nama pengguna last.fm berhasil dibersihkan dari basis data saya!"
    )
...
def last_fm(update: Update, _):
    ...
    if not username:
        msg.reply_text("Anda belum menetapkan nama pengguna Anda!")
        return
    ...
    try:
        ...
        msg.reply_text("Sepertinya Anda belum men-scrobble lagu apa pun...")
        return
